# Generated by Powerlevel10k configuration wizard on 2024-03-28 at 22:23 +03.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 52069.
# Wizard options: awesome-fontconfig + powerline + python, small icons, lean_8colors,
# unicode, 24h time, 1 line, compact, many icons, concise, instant_prompt=verbose.
